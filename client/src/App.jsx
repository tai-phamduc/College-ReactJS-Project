...
const Header = () => (
  <header className="bg-secondary py-4 px-8 shadow-custom sticky top-0 z-50">
    <div className="container flex justify-between items-center">
      ...
      <nav className="hidden md:flex space-x-6">
        ...
        <a href="/movies" className="text-white hover:text-primary transition-colors">Movies</a>
        <a href="/events" className="text-white hover:text-primary transition-colors">Events</a>
        <a href="/news" className="text-white hover:text-primary transition-colors">News</a>
      </nav>
      <div className="flex items-center space-x-4">
        <a href="/login" className="text-white hover:text-primary transition-colors">Login</a>
        <a href="/register" className="btn btn-primary py-1 px-4">Register</a>
      </div>
    </div>
  </header>
);
...
const Footer = () => (
  <footer className="bg-secondary pt-12 pb-6 text-white">
    <div className="container">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div>
          ...
          <p className="text-muted">Your premier destination for movies and entertainment</p>
        </div>
        <div>
          <h4 className="font-bold mb-4">Quick Links</h4>
          <ul className="space-y-2">
            <li><a href="/movies" className="text-muted hover:text-primary transition-colors">Movies</a></li>
            <li><a href="/events" className="text-muted hover:text-primary transition-colors">Events</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li><a href="/faq" className="text-muted hover:text-primary transition-colors">FAQ</a></li>
            <li><a href="/contact" className="text-muted hover:text-primary transition-colors">Contact Us</a></li>
            <li><a href="/terms" className="text-muted hover:text-primary transition-colors">Terms of Service</a></li>
          </ul>
        </div>
        <div>
      ...
      <div className="border-t border-light-gray pt-6 text-center text-sm text-muted">
